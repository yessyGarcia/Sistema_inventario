...
while ($row = $resultado->fetch_assoc())
{
    ...
    $objPHPExcel->getActiveSheet()->setCellValue('A'.$fila, $row['idfuentefinanciamiento']); 
    $objPHPExcel->getActiveSheet()->setCellValue('B'.$fila, $row['nombre']); 
    $objPHPExcel->getActiveSheet()->setCellValue('C'.$fila, $row['codigofuentefinanciamiento']); 
