                  ...
                  <?php foreach($this->model->ListarTipocomprobanteActivas() as $r): ?>
                      <tr>
                          ...
                          <td class="center">
                              ...
                              <a href="NuevoExcel/tipocomprobante.php" title="Imprimir en Excel" ><i class="small material-icons green-text">print</i></a><br>
                              <a href="word/tipocomprobante.php" title="Imprimir en Word" ><i class="small material-icons blue-text">print</i></a><br>
                          </td>
                      </tr>
                  <?php endforeach; ?>
                  </tbody>
