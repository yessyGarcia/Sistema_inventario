                  ...
                  <?php foreach($this->model->ListarDepartamentoActivos() as $r): ?>
                      <tr>
                          ...
                          <td class="center">
                              ...
                              <a href="NuevoExcel/departamento.php" title="Imprimir en Excel" ><i class="small material-icons green-text">print</i></a><br>
                              <a href="word/departamento.php" title="Imprimir en Word" ><i class="small material-icons blue-text">print</i></a><br>
                          </td>
                      </tr>
                  <?php endforeach; ?>
                  </tbody>
